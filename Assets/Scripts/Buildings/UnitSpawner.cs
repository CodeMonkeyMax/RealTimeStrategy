...
public class UnitSpawner : NetworkBehaviour, IPointerClickHandler
{
    ...
    private void ProduceUnits() {
        ...
        Vector3 spawnOffset = UnityEngine.Random.insideUnitSphere * spawnMoveRange; // unit sphere returns random value in sphere w/ radius = 1 unit
    ...
    private void UpdateTimerDisplay() {
        ...
        if ( newProgress < unitProgressImage.fillAmount ) {
            unitProgressImage.fillAmount = newProgress; // snap back to 0 or near 0
        } else {
    ...
    private void ClientHandleQueuedUnitsUpdated(int oldUnits, int newUnits)  { // these unit ints represent the queue
